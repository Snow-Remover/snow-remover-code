...
namespace Robot
{
  namespace Hardware
  {
    ...
    StepperMotor Main::lidar_stepper_motor = StepperMotor(motor_shield.get_stepper_motor(2), 200, StepperMotor::StepType::Double);
    ...
    ServoMotor Main::plow_servo_motor = ServoMotor(46, Measurement::Angle::from_degrees(0.0));
